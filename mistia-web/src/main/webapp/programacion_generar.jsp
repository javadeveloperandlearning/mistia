...
<html>
    ...
    <style>
        .toggler { width: 100%; height: 70%; }
        #button { padding: .5em 1em; text-decoration: none; }
        #effect { width: 97%; height: 75%; padding: 0.4em; position: relative; }
    ...
    <!--inicio solicitudes -->
    <div id="soli-div">
        <button style="width:100%" id="btnmostrarcontentsoli"  class="ui-button ui-widget ui-corner-all">            
            ...
            <div id="effect"  class="ui-widget-content ui-corner-all">
                <table>
                    ...
                    <tr>
                        ...
                        <td> 	   
                            <select name="cmbdistrito" id="cmbdistrito">
                    ...
                    <tr>
                        <td> 
                            <label for="cmbtiposolicitud">Tipo de solicitud :</label> 
                        </td>

                        <td> 	   
                            <select name="cmbtiposolicitud" id="cmbtiposolicitud">
                            </select>
                        </td>
                        <td> 
    ...
    <div id="cuadrilla-div">
       ...
       <button style="width:100%" id="btnlistarcuadrillas"  class="ui-button ui-widget ui-corner-all">            
            Lista de cuadrillas
            <span  class="ui-icon ui-icon-circle-triangle-s"></span> 
        </button>
        ...
        <table  id="cuadrillas-list"  class="cuadrillas-list"  width="100%" border="0"  cellspacing="5"  cellpadding="6" >
...
<script >
    ...
    function loadMap(solicitudesselect, numerogrupos) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                cargarsolicitudes(data.grupos, $("#cmbdistrito").val(), $("#cmbtiposolicitud").val());
    ...
    var addListenerOnMarker = function (marker) {
        ...
        google.maps.event.addListener(marker, 'dragend', function handleEvent(event) {
            ...
            console.log("reasignando puntos");
            $marker = this;
