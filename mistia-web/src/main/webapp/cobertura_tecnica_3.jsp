    ...
    <script >
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var marker = new google.maps.Marker({
                                position: myLatLng,
                                map: map,
                                descripcion: '<p><strong> Dirección para el servicio ' + formatted_address + '</strong> </p>',
                                draggable: true,
                                icon: pinImage,
                                shadow: pinShadow,
                                editable: true,
        ...
        function pintarmapa(nodos) {
            ...
            for (var i = 0; i < nodos.length; i++) {
                ...
                // postes mas cercanos
                postes = nodos[i].postes;
                for (var k in postes) {
                    //var _color = '#446600';
                    poste = postes[k];
                    var pColor = poste.color.substring(1, poste.color.length);
                    var pImage = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|" + pColor,
                            new google.maps.Size(21, 34),
                            new google.maps.Point(0, 0),
                            new google.maps.Point(10, 34));
                    ...
                    new google.maps.Marker({
                        position: {lat:poste.latitud, lng: poste.longitud},
                        map: map,
                        icon: pImage,
                        shadow: pShadow,
                        fillColor: "blue",
                ...
                /* flightPlanCoordinates.push({lat: g.latitudcentral, lng: g.longitudcentral});
            ...
            /* var triangleCoords = [
             ...
             for (k in triangleCoords) {
             
             new google.maps.Marker({
             position: triangleCoords[k],
             map: map,
             icon: {
             path: google.maps.SymbolPath.CIRCLE,
             fillColor: '#FF0000',
