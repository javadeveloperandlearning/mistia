...
public class SollicitudServicioConsultaController implements Serializable {
    ...
    public void init() {
        ...
        codigoTipoSolicitud = ConstantBusiness.CODIGO_TODOS;
        codigoEstado = ConstantBusiness.CODIGO_TODOS;
    ...
    public void nuevo() {
        ...
        try {
            ...
            request.getSession(false).setAttribute("numerosolicitudedit", null);
            soliservgene.init();
    ...
    public String editar(Object object) {
        try {
            ...
            request.getSession(false).setAttribute("numerosolicitudedit", numerosolicitud);
            soliservgene.init();
            return ConstansView.SOLICITUD_SERVICIO_GENERAR_VIEW;
