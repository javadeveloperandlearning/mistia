...
public class TecnicoDao extends CrudDao<Tecnico> {
    ...
    public List<Tecnico> getTecnicoList(Long numeroSolicitud) {
        logger.info("metodo : getTecnicoList ");
        logger.info(" numeroSolicitud:" + numeroSolicitud);
        List<Tecnico> tecnicoList = Collections.EMPTY_LIST;
        ...
        try {
            ...
            tecnicoList =  query.getResultList();
