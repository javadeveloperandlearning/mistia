...
public class GrupoAtencionDetallePK implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        return (this.numeroGrupoAtencion == castOther.numeroGrupoAtencion)
    ...
    public String toString() {
        return "GrupoAtencionDetallePK{" + "numeroGrupoAtencion=" + numeroGrupoAtencion + ", numeroOrden=" + numeroOrden + '}';
    }
