...
public class TecnicoCompetenciaDetallePK implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        return this.codigoTecnico.equals(castOther.codigoTecnico)
    ...
    public String toString() {
        return "TecnicoCompetenciaDetallePK{" + "codigoTecnico=" + codigoTecnico + ", codigoCompetencia=" + codigoCompetencia + '}';
    }
