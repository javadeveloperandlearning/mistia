...
public class Servicio implements Serializable {
    ...
    public String toString() {
        return "Servicio{" + "codigoServicio=" + codigoServicio + ", descripcion=" + descripcion + ", tarifa=" + tarifa + ", veloInterMbps=" + veloInterMbps + ", tipoPaqueteCable=" + tipoPaqueteCable + ", cantidadTelevisor=" + cantidadTelevisor + ", tipoServicio=" + tipoServicio + '}';
    }
